...
No current-topic interactive artifact & Local Gradio learning prototype & Make the formal game inspectable & Demo tests and local HTTP smoke check & \texttt{demo/}\\
\bottomrule
\end{tabularx}
\end{table}
