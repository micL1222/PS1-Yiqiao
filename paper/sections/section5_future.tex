...
\noindent\textbf{Roadmap:} Foundation: information incentives and computational cognition. PS1: a formal game, verified computation, and local educational prototype. Next: actual AI or human choice and belief study. Longer term: test mechanisms that assign research responsibility efficiently and robustly; none is developed here.
...
GitHub: [pending publication]. Google Colab: [pending publication]. Local source code, notebook, dependencies, actual outputs, tests, demo, and verification workflow exist. Reproduce locally with \texttt{./scripts/verify\_all.sh}. No explicit reuse license has yet been granted; public availability should not be interpreted as additional reuse permission.

\noindent\textbf{Statement of Contribution to the UN's SDGs.}
Hugging Face: [pending deployment]. A local Gradio prototype lets game-theory students change \(V,c\), choose actions, and inspect best responses and equilibria. Its intended learning goal aligns with SDG 4's quality-education aim~\cite{un_sdg4}. A future pre/post equilibrium-identification task could assess learning. Educational effectiveness has not been evaluated.
\label{main:end}
