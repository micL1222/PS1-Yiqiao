...
GitHub: [pending publication]. Google Colab: [pending publication]. Local source code, notebook, dependencies, actual outputs, tests, and verification workflow exist. Reproduce locally with \texttt{./scripts/verify\_all.sh}; public release and reuse terms await author action.
