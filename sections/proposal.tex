...
Nash and Harsanyi provide foundations in strategic interdependence, non-cooperative equilibrium, and incomplete information~\cite{nash1950,harsanyi1968,nobel1994game}. Newell and Simon connect artificial intelligence with human cognition~\cite{acm1975newellsimon}; Simon's bounded-rationality account of organizational decision-making links limited capacity to communication and authority structures~\cite{simon1978lecture}. These foundations do not determine how modern specialized AI agents should earn access to scarce human attention. This proposal contributes a falsifiable interruption-authority framework connecting allocation incentives, transparent scheduling, and burden-versus-trust mechanisms.
